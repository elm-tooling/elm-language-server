...
import { DocumentFormattingParams, IConnection, Range, TextEdit } from "vscode-languageserver";
...
export class ElmFormatProvider {
    ...
    protected handleFormattingRequest = async (
        ...
        try {
            ...
            const format = execCmd("elm-format", options, this.elmWorkspaceFolder, this.connection);
